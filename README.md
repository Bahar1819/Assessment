...
This is TestNG in Selenium automation framework with Java programming language.

Please open docs folder to see the requirements.

Please open the src/test folder to run the test.

IntelliJ IDE is the best IDE to run this code. 